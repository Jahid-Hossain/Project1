           ...
           <option>System user</option>
            <option>Desired User</option>
                    ...
                    <div class="form-group">
                        <a href="dashboard_2.html"> <input type="login" value="Login" class="btn float-right login_btn"></a>
                        {{ __('Login') }}
            ...
            <div class="card-footer">
                <div class="d-flex justify-content-center links">
                    Don't have an account?<a href="{{ route('register') }}">Register</a>Sign Up</a>
                </div>
